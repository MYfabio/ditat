...
const ERROR_MESSAGES: Record<string, string> = {
  CentreNoRegistrat:
    "Aquest correu no pertany a cap centre donat d'alta a dictats.cat. Comprova que fas servir el compte del teu centre educatiu, o demana a la direcció que registri el domini.",
